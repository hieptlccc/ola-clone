...
7. Download the repository [here](https://github.com/hieptl/ola-clone/archive/main.zip) or by running `git clone https://github.com/hieptl/ola-clone.git` and open it in a code editor.
...
Questions about running the demo? [Open an issue](https://github.com/hieptl/ola-clone/issues). We're here to help ✌️
